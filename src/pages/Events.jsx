...
const Events = () => {
  ...
  const scriptUrl =
    "https://script.google.com/macros/s/AKfycbwtDYZ-mz30vcn21q91LYRNRHXuQuzYEF-jdFtg6ravA1W-B882fGsBty0wSHIE7hH9pg/exec";
    ...
    fetch(scriptUrl, { method: "POST", body: new FormData(formRef.current) })
      .then((response) => {
        if (response.status === 200 || 201) {
          setLoading(false);
          toast.success(
            "Congratulation🎉, You have successfully registered for the event",
            {
              position: "top-right",
              autoClose: 5000,
        ...
        <div className="events-form">
          ...
          <div className="form-container">
            <form onSubmit={handleSubmit} ref={formRef}>
              ...
              <div className="form-group">
                <label htmlFor="softwarejourney">
                  Where are you in your Software Development Journey?
                </label>
                <select name="softwarejourney" id="softwarejourney" required>
                  <option value=""> </option>
                  <option value="I'm not a software developer">
                    I'm not a software developer
                  </option>
                  <option value="I want to learn software development">
                    I want to learn software development
                  </option>
                  <option value="I just started out in software development some months back">
                    I just started out in software development some months back
                  </option>
                  <option value="I have been doing software development for some years">
                    I have been doing software development for some years
                  </option>
                </select>
              </div>
              <div className="form-group">
                <label htmlFor="howyouknew">
                  Where did you hear about the session?
                </label>
