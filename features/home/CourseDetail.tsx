      ...
      <Box width={["100%", "60%"]}>
        ...
        <Box mt="1.7rem">
          <Text
            ...
            fontWeight="300"
          >
         The frontend development training is designed to equip you with the skills to write codes in HTML, JAVASCRIPT, REACTJS to create the frontend of products - what the users can see and interact with. At the end of the training, you will be able to create the front-end interface of any website and be able to work with any team globally.
          </Text>
        </Box>
