    ...
    >
      ...
      >
        <Image
          ...
          width="100%"
          objectFit={"cover"}
          src="assets/images/home/heroImage1.png"
          alt="hero"
        ...
        <Box
          ...
          borderRadius=".8319rem"
        >
          <Text fontSize="1.125rem" fontWeight="600" color="#434343">
            Ahmed Biola
          </Text>
          <Text color="#545656" fontSize=".75rem" fontWeight="400">
      ...
      >
        <Image
          ...
          width="100%"
          objectFit={"cover"}
          src="assets/images/home/heroImage2.png"
          alt="hero"
      ...
      >
        <Image
          ...
          width="100%"
          objectFit={["cover"]}
          src="assets/images/home/heroImage3.png"
          alt="hero"
