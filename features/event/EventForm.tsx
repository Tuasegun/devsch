...
export const EventForm = () => {
  const { hasCopied, onCopy } = useClipboard("https://schfordevs/events");
  const formRef = useRef(null);
  const [loading, setLoading] = useState(false);
  const scriptUrl =
    "https://script.google.com/macros/s/AKfycbwXuL6faioJXJxNFI7TbMP9CZEg_HD7nTf2MDBpFw5E4sr4V6zIHVW24MYTWZljmB1s/exec";
            ...
            <Box w="full">
              ...
              <Box>
                ...
                >
                  ...
                  <Box>
                    {hasCopied ? (
                      <Text fontSize="0.8rem">Copied!</Text>
                    ) : (
